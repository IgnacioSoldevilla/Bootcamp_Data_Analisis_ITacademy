...
-- Añado el registro con los datos PERO DA EL ERROR CON CODIGO 1452 AL NO ESTAR DEFINIDOS LOS DATOS NECESARIOS EN LAS TABLAS RELACIONADAS
...
-- EJERCICIO 1.  *************** Todo exolicado en el fichero pdf del sprint 03 y solo faltaria ejecutar el añadir el campo "fecha_actual" del tipo DATE en la tabla "credit_card" ******************************
